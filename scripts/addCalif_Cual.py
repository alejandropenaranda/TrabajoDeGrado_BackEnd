...
from core.models import CalificacionesCualitativas, Usuario, Materia
...
def insertar_calif_cualitativas_desde_excel(archivo):
    ...
    print(f'Se han insertado {len(df)} registros de calificaciones cualitativas desde el archivo {archivo}')

if __name__ == '__main__':
    archivo = './Datasets/calificaciones_cualitativas.xlsx'  # Ruta al archivo Excel
