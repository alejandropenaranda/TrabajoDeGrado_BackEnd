...
from core.models import Usuario, CalificacionesCualitativas, CalificacionesCuantitativas, PromedioCalificaciones
...
def calcular_promedios():
    ...
    for docente in docentes:
        # Obtener promedios cualitativos por periodo
        promedios_cualitativos = CalificacionesCualitativas.objects.filter(docente=docente).values('periodo').annotate(promedio=Avg('promedio'))
        
        # Obtener promedios cuantitativos por periodo
        promedios_cuantitativos = CalificacionesCuantitativas.objects.filter(docente=docente).values('periodo').annotate(
